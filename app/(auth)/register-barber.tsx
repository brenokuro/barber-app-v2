...
export default function BarberRegisterScreen() {
  ...
  const handleRegister = async () => {
    ...
    setIsLoading(true);
    try {
      await register(name, email, password, "admin", phone);
      ...
      <View style={[styles.content, { paddingTop: insets.top }]}>
        ...
        >
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Gerencie seu negócio com profissionalismo</Text>
          </View>
          ...
          <View style={styles.form}>
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputContainer}>
                <Feather name="briefcase" size={20} color={Colors.textMuted} style={styles.inputIcon} />
                <TextInput
                  style={styles.input}
                  value={name}
            ...
            <View style={styles.noticeBox}>
              ...
              <Text style={styles.noticeText}>
                O telefone será usado para contato com clientes e confirmações de agendamentos
              </Text>
            </View>
            ...
            >
              {isLoading ? (
                ...
                <Text style={styles.registerBtnText}>Cadastrar Barbearia</Text>
              )}
            </Pressable>
          </View>
          ...
          <View style={styles.footer}>
            ...
            <Pressable onPress={() => router.push("/(auth)/login-barber")}>
