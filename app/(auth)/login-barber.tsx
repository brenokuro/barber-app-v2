      ...
      <View style={[styles.content, { paddingTop: insets.top }]}>
        ...
        >
          <View style={styles.header}>
            ...
            <Text style={styles.title}>Área da Barbearia</Text>
            <Text style={styles.subtitle}>Gerencie seu negócio com facilidade</Text>
          </View>
          ...
          <View style={styles.form}>
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputContainer}>
                ...
                <TextInput
                  ...
                  placeholder="admin@sua-barbearia.com"
            ...
            <View style={styles.securityNotice}>
              ...
              <Text style={styles.securityText}>
                Acesso restrito a administradores da barbearia
              </Text>
            </View>

            <Pressable style={styles.forgotPassword}>
              <Text style={styles.forgotPasswordText}>Problemas com o acesso?</Text>
            </Pressable>
            ...
            >
              {isLoading ? (
                ...
                <Text style={styles.loginBtnText}>Acessar Painel</Text>
              )}
            </Pressable>
          </View>

          <View style={styles.footer}>
            <Text style={styles.footerText}>Nova barbearia na plataforma?</Text>
            <Pressable onPress={() => router.push("/(auth)/register-barber")}>
              <Text style={styles.signUpText}>Cadastrar negócio</Text>
            </Pressable>
          </View>
