...
function getDeploymentDomain() {
  ...
  console.error(
    "ERROR: Defina EXPO_PUBLIC_API_URL ou EXPO_PUBLIC_DOMAIN para o build.",
  );
  process.exit(1);
}
...
function clearMetroCache() {
  ...
  const cacheDirs = [
  ...(fs.existsSync(".metro-cache") ? [".metro-cache"] : []),
  ...(fs.existsSync("node_modules/.cache/metro") ? ["node_modules/.cache/metro"] : []),
];
